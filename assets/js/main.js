...
(() => {
  ...
  const translations = {
    es: {
      ...
      partner_website_cta: "Ver web",
      partner_can_marc_name: "Can Marc",
      partner_can_marc_desc: "Venue colaborador en la Costa Brava.",
      partner_bcn_alturas_name: "BCN en las Alturas",
      partner_bcn_alturas_desc: "Evento de referencia para experiencias lifestyle, música y marca.",
      partner_future_badge: "Disponible",
      partner_future_name: "Próximo partner",
      partner_future_desc: "Placeholder preparado para añadir nuevos colaboradores y sus logos.",
    ...
    ca: {
      ...
      partner_website_cta: "Veure web",
      partner_can_marc_name: "Can Marc",
      partner_can_marc_desc: "Venue col·laborador a la Costa Brava.",
      partner_bcn_alturas_name: "BCN en las Alturas",
      partner_bcn_alturas_desc: "Esdeveniment de referència per a experiències lifestyle, música i marca.",
      partner_future_badge: "Disponible",
      partner_future_name: "Proper partner",
      partner_future_desc: "Placeholder preparat per afegir nous col·laboradors i els seus logos.",
    ...
    en: {
      ...
      partner_website_cta: "View website",
      partner_can_marc_name: "Can Marc",
      partner_can_marc_desc: "Collaborating venue in Costa Brava.",
      partner_bcn_alturas_name: "BCN en las Alturas",
      partner_bcn_alturas_desc: "Reference event for lifestyle, music and brand experiences.",
      partner_future_badge: "Available",
      partner_future_name: "Next partner",
      partner_future_desc: "Placeholder ready for future collaborators and their logos.",
