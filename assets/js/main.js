...
(() => {
  ...
  const translations = {
    es: {
      ...
      hero_intro:
        'Somos <span class="text-lg font-extrabold sm:text-xl">Costa Brava Music Events</span>, tu partner de confianza para bodas, eventos privados, cumpleaños, aniversarios, inauguraciones, fiestas mayores y verbenas en la Costa Brava.',
      ...
      hero_signature: "La Costa Brava suena mejor con nosotros.",
      ...
      moments_copy:
        "Momentos reales de nuestros eventos: música en directo, energía en pista y puesta en escena cuidada.",
      moment_1_title: "Boda",
    ...
    ca: {
      ...
      hero_intro:
        'Som <span class="text-lg font-extrabold sm:text-xl">Costa Brava Music Events</span>, el teu partner de confiança per a casaments, esdeveniments privats, aniversaris, inauguracions, festes majors i revetlles a la Costa Brava.',
      ...
      hero_signature: "La Costa Brava sona millor amb nosaltres.",
      ...
      moments_copy: "Moments reals dels nostres esdeveniments: música en directe, energia a la pista i posada en escena cuidada.",
    ...
    en: {
      ...
      hero_intro:
        'We are <span class="text-lg font-extrabold sm:text-xl">Costa Brava Music Events</span>, your trusted partner for weddings, private events, birthdays, anniversaries, openings, local festivals and traditional celebrations on the Costa Brava.',
      ...
      hero_signature: "The Costa Brava sounds better with us.",
      ...
      moments_title: "Moments",
      moments_copy: "Real moments from our events: live music, dancefloor energy and carefully crafted staging.",
