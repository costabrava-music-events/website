...
(() => {
  ...
  const translations = {
    es: {
      ...
      hero_bullet_1: "DJ y una selección musical pensada para tus invitados",
      hero_bullet_2: "Música en directo para el cóctel, la cena y los momentos clave",
      hero_bullet_3: "Sonido profesional, claro y proporcionado al espacio",
      hero_bullet_4: "Iluminación para dar carácter a cada zona y elevar la fiesta",
      hero_bullet_5: "Coordinación técnica para que el día avance sin imprevistos",
      hero_outro:
        "Desde la ceremonia hasta la última canción, cuidamos el ritmo del día para que tú solo tengas que disfrutarlo.",
      hero_signature: "Tú imaginas cómo quieres que se sienta. Nosotros lo hacemos realidad.",
      hero_cta_primary: "Pedir mi propuesta",
      hero_cta_whatsapp: "Hablar por WhatsApp",
      proposal_title: "¿Quieres que preparemos tu propuesta?",
      proposal_copy:
        "Cuéntanos la fecha, el espacio y el número de invitados. Te responderemos con una propuesta clara y ajustada a tu celebración.",
      proposal_cta: "Pedir propuesta",
      ...
      partner_la_cala_navega_name: "La Cala Navega",
      partner_la_cala_navega_desc: "Propuesta gastronómica de Palamós liderada por el chef Tomàs Brull, con producto del mar, cocina catalana y una mirada contemporánea.",
    ...
    ca: {
      ...
      hero_bullet_1: "DJ i una selecció musical pensada per als teus convidats",
      hero_bullet_2: "Música en directe per al còctel, el sopar i els moments clau",
      hero_bullet_3: "So professional, clar i proporcionat a l'espai",
      hero_bullet_4: "Il·luminació per donar caràcter a cada zona i fer créixer la festa",
      hero_bullet_5: "Coordinació tècnica perquè el dia avanci sense imprevistos",
      hero_outro: "Des de la cerimònia fins a l'última cançó, cuidem el ritme del dia perquè tu només t'hagis de dedicar a gaudir-lo.",
      hero_signature: "Tu imagines com vols que se senti. Nosaltres ho fem realitat.",
      hero_cta_primary: "Demanar la meva proposta",
      hero_cta_whatsapp: "Parlar per WhatsApp",
      proposal_title: "Vols que preparem la teva proposta?",
      proposal_copy: "Explica'ns la data, l'espai i el nombre de convidats. Et respondrem amb una proposta clara i ajustada a la teva celebració.",
      proposal_cta: "Demanar proposta",
      ...
      partner_la_cala_navega_name: "La Cala Navega",
      partner_la_cala_navega_desc: "Proposta gastronòmica de Palamós liderada pel xef Tomàs Brull, amb producte del mar, cuina catalana i una mirada contemporània.",
      partner_bcn_alturas_name: "BCN en las Alturas",
    ...
    en: {
      ...
      hero_bullet_1: "Professional DJs and a music plan built around your guests",
      hero_bullet_2: "Live music for the ceremony, cocktail hour, dinner or key moments",
      hero_bullet_3: "Clear, well-sized sound for your venue",
      hero_bullet_4: "Lighting that gives every space its own atmosphere",
      hero_bullet_5: "Technical coordination so the day runs smoothly",
      hero_outro:
        "From the ceremony to the final song, we look after the flow of the day so you can enjoy it.",
      hero_signature: "You set the feeling. We bring it to life.",
      hero_cta_primary: "Request my proposal",
      hero_cta_whatsapp: "Talk to us on WhatsApp",
      proposal_title: "Planning a destination wedding or event?",
      proposal_copy: "Tell us your date, venue and guest count. We will come back with a clear proposal tailored to your celebration.",
      proposal_cta: "Request a proposal",
      ...
      partner_la_cala_navega_name: "La Cala Navega",
      partner_la_cala_navega_desc: "A Palamós culinary project led by chef Tomàs Brull, combining seafood, Catalan cooking and a contemporary approach.",
      partner_bcn_alturas_name: "BCN en las Alturas",
